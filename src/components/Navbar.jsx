function Navbar() {
  return (
    <nav className="w-full h-16 bg-slate-800 border-b border-gray-100 shadow-sm flex items-center justify-between px-4 md:px-10 fixed top-0 left-0 z-50">
      ...
      <div className="flex items-center gap-3">
        <button className="text-sm font-medium text-white hover:text-orange-600 transition-colors duration-300">
          Ajuda
        </button>
